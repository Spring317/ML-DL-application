...
print(
    f"Data shapes: {x_train_tfidf.shape}, {x_test_tfidf.shape}, {y_train.shape}, {y_test.shape}"
)
...
lr_params = {"C": 2, "max_iter": 1000, "solver": "lbfgs", "multi_class": "auto"}
...
mnb_params = {"alpha": 1.0, "fit_prior": True}
...
rf = RandomForestClassifier(
    n_estimators=100, max_depth=None, min_samples_split=2, random_state=42, n_jobs=-1
)
